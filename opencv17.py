...
cv2.createTrackbar('red color', 'RGB tack bar', 0, 255, nothing)
cv2.createTrackbar('green color', 'RGB tack bar', 0, 255, nothing)
cv2.createTrackbar('blue color', 'RGB tack bar', 0, 255, nothing)
